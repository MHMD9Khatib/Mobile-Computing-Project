...
public class activityHome extends AppCompatActivity {
    ...
    String userId, stuts, gender,userWeight, userLenght, birthday;RecyclerView recyclerView;
    Button newRecord, viewFood, addFood;
    TextView logout, status, name, load;
    FirebaseAuth firebaseAuth;com.example.bmiProject.listRecordAdapter listRecordAdapter;
    List<Records> recordsList;
    double ageparcent = 0,w,l,bmiPercent, bmiChange, bmiLast, bmiTowLast;Calendar calendar;
    int age, year;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewFood = findViewById(R.id.viewFood);addFood = findViewById(R.id.addFood);
        status = findViewById(R.id.status);
        newRecord = findViewById(R.id.newRecord);logout = findViewById(R.id.logout);
        recyclerView = findViewById(R.id.recyclerViews);
        name = findViewById(R.id.name);
        recordsList = new ArrayList<>();firebaseAuth = FirebaseAuth.getInstance();
        ...
        viewFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), activityListFood.class);startActivity(intent);
            }
        });
        ...
        newRecord.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), activityNewRecord.class);startActivity(intent);
            }
        });
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (age >= 20) {
                                    ageparcent = 1;
                                    bmiPercent = (w / l) * ageparcent; } else if ((age >= 10 && age <= 19) && gender.equals("Male")) {
                                    ageparcent = 0.90;
                                    bmiPercent = (w / l) * ageparcent; } else if ((age >= 10 && age <= 19) && gender.equals("Female")) {
                                    ageparcent = 0.80;
                                    bmiPercent = (w / l) * ageparcent; } else if (age >= 2 && age <= 10) {
                                    ageparcent = 0.7;
                                ...
                                if (bmiPercent > 30) {
                                    stuts = "Obesity";
                                } else if (bmiPercent <= 30 && bmiPercent > 25) { stuts = "Overweight";
                                } else if (bmiPercent <= 25 && bmiPercent > 18.5) { stuts = "Healthy Weight";
                                } else if (bmiPercent <= 18.5) { stuts = "Underweight";
                                }
                            ...
                            if (recordsList.size() < 1) {
                                ...
                                switch (stuts) {
                                    case "Obesity":
                                        ...
                                        } else if ((bmiChange < -0.3 && bmiChange >= -0.6) || (bmiChange >= -0.3 && bmiChange > 0)) { status.setText(stuts + " Little Changes");
                                        } else if (bmiChange >= 0 && bmiChange < 0.3) {
                                            status.setText(stuts + " Be Careful");
                                        } else if ((bmiChange >= 0.3 && bmiChange < 0.6) || (bmiChange >= 0.6 && bmiChange < 1) || bmiChange >= 1) { status.setText(stuts + " So Bad");
                                        }
                                        break;
                                    ...
                                    case "Overweight":
                                        if ((bmiChange < -1) || (bmiChange >= 0.3 && bmiChange < 0.6)) {
                                            status.setText(stuts + " Be Careful");
                                        } else if ((bmiChange >= -1 && bmiChange < -0.6)) { status.setText(stuts + " Go Ahead");
                                        } else if ((bmiChange < -0.3 && bmiChange >= -0.6)) { status.setText(stuts + " still good");
                                    ...
                                    case "Underweight":
                                        if ((bmiChange < -1) || (bmiChange >= -1 && bmiChange < -0.6) ||
                                            ...
                                            status.setText(stuts + " So Bad");
                                        } else if ((bmiChange >= -0.3 && bmiChange < 0) || (bmiChange >= 0 && bmiChange < 0.3)) { status.setText(stuts + " Little Changes");
                                        } else if ((bmiChange >= 0.3 && bmiChange < 0.6)) { status.setText(stuts + " Still Good");
                                        } else if ((bmiChange >= 0.6 && bmiChange < 1) || bmiChange >= 1) {
                                            status.setText(stuts + " Go Ahead");
                                        }
                                ...
                                recyclerView.setVisibility(View.VISIBLE);
                                bmiLast = recordsList.get(0).getBmiForRecords();bmiTowLast = recordsList.get(1).getBmiForRecords();
                                ...
                                switch (stuts) {
                                    ...
                                    case "Overweight":
                                        if ((bmiChange < -1) || (bmiChange >= 0.3 && bmiChange < 0.6)) {
                                            ...
                                            status.setText(stuts + " Little Changes");
                                        } else if ((bmiChange >= 0.6 && bmiChange < 1) || bmiChange >= 1) { status.setText(stuts + " So Bad");
                                        }
                                        break;
                            ...
                            recyclerView.setHasFixedSize(true);recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                            recyclerView.setAdapter(listRecordAdapter);Log.d("TAG", recordsList.size()+"");
