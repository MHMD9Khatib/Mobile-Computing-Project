...
public class activityNewRecord extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
    ...
    Button maxLength, minLength, minWei, maxWei, save;EditText length, weight;

    int countW = 50, countL = 120;


    Records records;FirebaseFirestore firebaseFirestore;
    FirebaseAuth firebaseAuth;String userId;
    TextView date, time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minLength = findViewById(R.id.minLength);minWei = findViewById(R.id.minWei);
        maxWei = findViewById(R.id.maxWei);
        save = findViewById(R.id.btn_saveData);
        date = findViewById(R.id.date);length = findViewById(R.id.length);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogFragment datePicker = new Dateick();
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment timePicker = new TimPic();
    ...
    public void save(View view) {
        ...
        records.setuId(userId);records.setDateRecords(date.getText().toString());
        records.setLengthRecords(length.getText().toString());
        records.setWeightRecords(weight.getText().toString());records.setTimeRecords(time.getText().toString());
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(getApplicationContext(), "done", Toast.LENGTH_SHORT).show();date.setText("");
                            time.setText("");
                            length.setText("");weight.setText("");
