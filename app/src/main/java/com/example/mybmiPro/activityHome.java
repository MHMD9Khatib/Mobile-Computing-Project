...
public class activityHome extends AppCompatActivity {
    ...
    FirebaseAuth firebaseAuth;com.example.mybmiPro.listRecordAdapter listRecordAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), activityListFoods.class);startActivity(intent);
            }
        });
